...
NSInteger const Mralertview_SIZE_WIDTH = 280;
NSInteger const Mralertview_SIZE_HEIGHT = 180;
...
- (instancetype)init
{
    self = [[HHAlertView alloc] initWithFrame:CGRectMake(([self getMainScreenSize].width-Mralertview_SIZE_WIDTH)/2, Screen_height/4.7, Mralertview_SIZE_WIDTH, Mralertview_SIZE_HEIGHT)];
//    self.alpha = 0;
...
- (void)configtext:(NSString *)title detail:(NSString *)detail
{
    ...
    if (_detailLabel==nil) {
        _detailLabel  = [[UILabel alloc] initWithFrame:CGRectMake(0, Simble_SIZE+Simble_TOP+Mralertview_SIZE_TITLE_FONT, [self getSelfSize].width, Mralertview_SIZE_TITLE_FONT)];
    }
