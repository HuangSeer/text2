 ...
 *  @param peripheral The TIOPeripheral instance this event applies for.
 *  @param rssi An NSNumber instance containing the current number of local UART credits.
 */
 ...
 *  @param peripheral The TIOPeripheral instance this event applies for.
 *  @param rssi An NSNumber instance containing the current number of remote UART credits.
 */
...
///@}
@property (nonatomic,copy) NSString* mServiceUUID;
@property (nonatomic,copy) NSString* mDataInUUID;
@property (nonatomic,copy) NSString* mDataOutUUID;
@property (nonatomic,copy) NSString* mCreditInUUID;
@property (nonatomic,copy) NSString* mCreditOutUUID;
